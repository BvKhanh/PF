...
const BillCT = {
    ...
    getTop5FoodsDetails: (callback) => {
        const sql = `
            SELECT sp.*, ctdh.ma_mon_an, SUM(ctdh.so_luong) AS total_quantity
            FROM chi_tiet_don_hang ctdh
            INNER JOIN san_pham sp ON ctdh.ma_mon_an = sp.ma_mon_an
            GROUP BY ctdh.ma_mon_an, sp.ma_mon_an
