...
export function LoadData() {
  ...
  for (let x of list) {
    ...
    str += `<div class="list-food__item">
      <div class="list-food__item-img">
        <img src="${x.img}" alt="">
      </div>
      <div class="list-food__item-content">
        <div class="list-food__item-name">${x.name}</div>
        <div class="list-food__item-type">${x.color}/${x.size}</div>
        <div style="display:flex;justify-content: flex-start; margin: 28px 0 6px;" class="">                         
        </div>
        <div style="display:flex;justify-content: space-between;align-items: center;">  
          <div class="quantity-food">
          ...
          <div class="food-price">
            <div class="food-new-price">${convertVND(x.price)}</div>
          </div>
        </div>
        <div class="list-food__close" onclick="Xoa('${x.id}','${
      x.size
    }','${x.color}')">
