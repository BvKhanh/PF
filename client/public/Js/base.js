...
//             var id = btn.closest('.food').id;
//             var name = document.getElementById(id).querySelector('.food-name').textContent;
//             var img = document.getElementById(id).querySelector('.food-img-1').getAttribute('src');
//             var category = document.getElementById(id).querySelector('.food-content__option-item-wrap.active span').dataset.category;
//             var size = btn.textContent;
//             var price = convertToNumber(document.getElementById(id).querySelector('.food-price').textContent);
//             var item = {
//                 id: id,
//                 name: name,
//                 img: img,
...
//             var img = document.querySelector(".food-img__option-item.active img").getAttribute("src");
//             var category = document.querySelector(".content__category-heading b").textContent;
...
//             var quantity = JSON.parse(document.querySelector(".food-single__actions .quantity span").textContent);
//             var item = {
//                 id: "detail1",
//                 name: name,
//                 img: img,
...
//             return x.id == id && x.size == size && x.category == category;
//         });
//         if (index >= 0) {
//             list.splice(index, 1);
//         }
...
//         document.querySelector(".notify-added__category").textContent = "" + item.category;
